...
@section('top-navbar')
    ...
    <li class="nav-item" style="padding-right: 5vh">
        <a type="button" href="{{ route('sunting_mitra') }}"
            style="background: #ffffff; border-radius: 45px; height: 40px; width: 100px; color: #F2A93A; display: flex; flex-direction: row; justify-content: center; align-items: center; padding: 18px 24px;">Mitra</a>
    </li>
    <li class="nav-item" style="padding-right: 5vh">
            ...
            <tbody>
                @foreach ($suntingMitra as $user)
                    <tr class="body-dark">
                        ...
                        <td>
                            <a href="{{ route('edit_mitra', $user->id) }}" class="btn tombol"><b>edit</b></a>
                            <a href="{{ route('delete_mitra', $user->id) }}" class="btn tombol"
